...
struct FileManagerTests {
    ...
    func buildsPublicAndPrivatePathsInsideInjectedDirectory() throws {
        ...
        let manager = RyzeFileManager(documentsURL: directory)
    ...
    func returnsNilWhenNoDocumentDirectoryExists() {
        let manager = RyzeFileManager(documentsURL: nil)
    ...
    func returnsNilWhenPrivateDirectoryCannotBeCreated() throws {
        ...
        let manager = RyzeFileManager(documentsURL: parent)
    ...
    func computesFileSizeAndFormatsBytes() throws {
        ...
        let missingSizeManager = RyzeFileManager(
    ...
    func filePrivacyRawValuesAreStable() {
        #expect(RyzeFilePrivacy.public.rawValue.isEmpty)
        #expect(RyzeFilePrivacy.private.rawValue == ".private")
    }
}
