...
struct NetworkFixtureResponse: RyzeEntity, Sendable {
    let id: Int
    let title: String
}
...
struct NetworkFixtureEndpoint: RyzeNetworkEndpoint {
...
struct NetworkFixtureRequest: RyzeNetworkRequest {
...
struct NetworkFixtureSocketCommand: RyzeNetworkSocketCommand {
    let message: String
}

struct NetworkFixtureSocketEndpoint: RyzeNetworkSocketEndpoint {
...
struct NetworkFixtureSocketRequest: RyzeNetworkSocketRequest {
    let endpoint: (any RyzeNetworkSocketEndpoint)?
}
...
final class MockSocketConnection: RyzeNetworkSocketConnection, @unchecked Sendable {
    ...
    func emit(_ state: RyzeNetworkSocketConnectionState) {
