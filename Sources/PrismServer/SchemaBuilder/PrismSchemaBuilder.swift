    ...
    public struct PrismForeignKey: Sendable {
        ...
        public init(
            column: String, references table: String, column refColumn: String,
            onDelete: PrismForeignKeyAction = .noAction
        ) {
            self.column = column
    ...
    public struct PrismTableBuilder: Sendable {
        ...
        public func column(_ name: String, _ type: PrismColumnType, constraints: [PrismColumnConstraint] = [])
            -> PrismTableBuilder
        {
            var copy = self
        ...
        public func foreignKey(
            _ col: String, references table: String, column refCol: String, onDelete: PrismForeignKeyAction = .noAction
        ) -> PrismTableBuilder {
            var copy = self
